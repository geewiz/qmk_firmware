...
[_DEFAULT] = LAYOUT_planck_grid(
  ...
  ESC_CTL, DH_A,    DH_S,    DH_D,    DH_F,    KC_G,    KC_H,    DH_J,    DH_K,    DH_L,    DH_SCLN, KC_QUOT,
...
[_LOWER] = LAYOUT_planck_grid(
  ...
  _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, U_SMCL , _______,
