...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______,    KC_MS_L,KC_MS_D,KC_MS_R,_______,_______,_______,_______,_______,_______,KC_LEFT,KC_RGHT,    _______,_______,KC_END,
        _______,    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_DOWN,    _______,KC_VOLU,KC_INS,
