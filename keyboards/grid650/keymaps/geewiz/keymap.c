...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MS_U, _______, _______, KC_HOME, KC_BSPC,
        _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_BTN1, KC_BTN2, _______, _______, _______, _______, KC_MS_L, KC_MS_R, _______, KC_LEAD, KC_END ,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MS_D, KC_LEAD, KC_PGUP, _______,
