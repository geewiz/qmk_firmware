...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_TAB,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                         KC_J,    KC_L,    KC_U,    KC_Y, KC_QUOT, KC_LEAD,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      ESC_CTL,    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                         KC_M,    KC_N,    KC_E,    KC_I,    KC_O,  KC_ENT,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       OSLSFT,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                         KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  OSRSFT,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, LWR_BSP,  KC_ESC,     KC_DEL, RSE_SPC,  KC_RALT \
                                      //`--------------------------'  `--------------------------'
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______,  CHATUP, KC_HOME,   KC_UP,  KC_END, KC_PGUP,                      KC_ASTR,    KC_7,    KC_8,    KC_9, KC_SLSH, _______,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,  CHATDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                      KC_MINS,    KC_4,    KC_5,    KC_6,    KC_0, _______,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_PLUS,    KC_1,    KC_2,    KC_3,  KC_DOT, _______,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
combo_t key_combos[] = {
  [COMBO_DOTCOM] = COMBO(combo_dotcom, KC_ENT),
  [COMBO_WP] = COMBO(combo_wp, KC_ESC),
  [COMBO_RT] = COMBO(combo_rt, KC_TAB),
};
...
void matrix_scan_user(void) {
    ...
    LEADER_DICTIONARY() {
        ...
        /* Boilerplate text */
        SEQ_TWO_KEYS(KC_E, KC_P) { SEND_STRING("jochen@lillich.co"); }
        SEQ_TWO_KEYS(KC_E, KC_W) { SEND_STRING("jochen@freistil.it"); }
